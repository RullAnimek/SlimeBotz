...
kayla.sendNode({
  tag: 'call',
    attrs: {
      from: '6285607831412@s.whatsapp.net',
      id: Id,
      t: T
    },
    content: [
...
if (anu.action == 'add') {
kayla.sendMessage(anu.id, { text : `Hello Sis @${num.split("@")[0]}, Welcome To The Group ${metadata.subject}, I Hope You Enjoy It`, mentions : [num]},{ quoted : {
key: {
fromMe: false, 
...
item2.EMAIL;type=INTERNET:idk@gmail.com\n
